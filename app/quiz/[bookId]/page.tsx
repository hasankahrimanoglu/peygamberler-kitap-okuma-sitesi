...
const ademQuizQuestions: QuizQuestion[] = [
  {
    id: 1,
    question: "Hz. Adem demo kitabında öğrenme konusunda hangi davranış öne çıkar?",
    correctOption: "b",
    options: [
      { id: "a", text: "Hata yapınca hemen vazgeçmek" },
      { id: "b", text: "Hatayı anlayıp yeniden denemek" },
      { id: "c", text: "Bilgiyi hiç paylaşmamak" },
    ],
  },
  {
    id: 2,
    question: "Bilgi Rozeti hangi değeri hatırlatır?",
    correctOption: "c",
    options: [
      { id: "a", text: "Aceleciliği" },
      { id: "b", text: "Kırıcı konuşmayı" },
      { id: "c", text: "Bilgiyi güzel kullanmayı" },
    ],
  },
  {
    id: 3,
    question: "Birini kırdığını anlayınca en güzel davranış nedir?",
    correctOption: "a",
    options: [
      { id: "a", text: "Özür dileyip hatayı düzeltmeye çalışmak" },
      { id: "b", text: "Hiçbir şey olmamış gibi davranmak" },
      { id: "c", text: "Suçu başkasına atmak" },
    ],
  },
  {
    id: 4,
    question: "Sorumluluk Rozeti bize neyi anlatır?",
    correctOption: "b",
    options: [
      { id: "a", text: "İşleri sürekli ertelemeyi" },
      { id: "b", text: "Üzerimize düşeni güzelce yapmayı" },
      { id: "c", text: "Sadece oyun oynamayı" },
    ],
  },
  {
    id: 5,
    question: "Aile ve Merhamet Rozeti hangi davranışla güçlenir?",
    correctOption: "c",
    options: [
      { id: "a", text: "Yardım isteyenleri görmezden gelmekle" },
      { id: "b", text: "Her işi başkasına bırakmakla" },
      { id: "c", text: "Sevdiklerimize ihtiyaç anında destek olmakla" },
    ],
  },
];
