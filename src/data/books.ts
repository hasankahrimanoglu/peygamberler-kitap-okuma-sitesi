export type BookContentBlock =
  ...
  | {
      ...
      // özel sayfa (YENI-KITAP-ICERIK-URETIM-BRIFI.md 7.5). Kurgusal tanıkta sistem
  ...
  chapters: [
    {
      ...
      paragraphs: [
        ...
        // "emanet" Hz. Âdem 8. bölümde zaten kutulandı; terim yalnız set genelinde
        // İLK geçtiği yerde etkileşimli olur (SOZLUKCE-SICILI.md). Burada düz metin.
        { type: "text", text: "Korunması ve doğru biçimde aktarılması gereken şeye emanet denir." },
